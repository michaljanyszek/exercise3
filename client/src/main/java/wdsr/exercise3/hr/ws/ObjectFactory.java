 ...
 * generated in the wdsr.exercise3.hr.ws package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: wdsr.exercise3.hr.ws
     * 
     */
